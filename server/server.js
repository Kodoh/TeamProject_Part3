...
app.post('/dataAnalytics/addEmployee', async function(req, res, next){
...
app.post('/dataAnalytics/addProject', async function(req,res,next){
...
app.post('/dataAnalytics/assignEmpToTask', async function(req, res,next){
...
app.post('/dataAnalytics/assignEmpToTeam', async function(req, res,next){
...
app.post('/dataAnalytics/assignTaskToTeam', async function(req, res,next){
